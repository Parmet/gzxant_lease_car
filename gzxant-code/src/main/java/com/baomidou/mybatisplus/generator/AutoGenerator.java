    ...
    private Map<String, VelocityContext> analyzeData(ConfigBuilder config) {
        ...
        for (TableInfo tableInfo : tableList) {
        	...
        	if (tableInfo.getFieldNames().contains("parent_id")) { // tree
        		type = "tree";
    		} else if (tableInfo.getFieldNames().contains("create_id")) { // data
    			type = "data";
    		} else { // base
    			type = "base";
    		}
            ...
            List<TableField> delFields = new ArrayList<>();
            for (TableField field : tableFields) {
            	if (field.getName().equals("id")
            		|| field.getName().equals("create_id") // data参数
            		|| field.getName().equals("create_date")
            		|| field.getName().equals("update_id)")
            		|| field.getName().equals("update_date")
            		|| field.getName().equals("del_flag")
            		|| field.getName().equals("remark")
            		|| (field.getName().equals("parent_id") // tree参数
            ...
            tableFields.removeAll(delFields);
...
//                tableInfo.setImportPackages("java.io.Serializable");
            ...
            // 根据数据库结构判断Entity以及Dao父类的类型（tree, data, base）
        	if (type.equals("tree")) { // tree
        		superEntityClass = "TreeEntity";
        		superEntityPackage = "com.gzxant.base.entity.TreeEntity";
        		superMapperClass = "TreeDao";
        		superMapperPackage = "com.gzxant.base.dao.TreeDao";
        		tableInfo.setImportPackages(superEntityPackage);
    		} else if (type.equals("data")) { // data
    			superEntityClass = "DataEntity";
        		superEntityPackage = "com.gzxant.base.entity.DataEntity";
        		superMapperClass = "CrudDao";
        		superMapperPackage = "com.gzxant.base.dao.CrudDao";
        		tableInfo.setImportPackages(superEntityPackage);
    		} else { // base
    			superEntityClass = "BaseEntity";
        		superEntityPackage = "com.gzxant.base.entity.BaseEntity";
        		superMapperClass = "BaseDao";
            ...
            ctx.put("superMapperClassPackage", superMapperPackage);
