...
public class ApacheHttpClient extends HttpClient {
    ...
    protected void init(final BuilderParams params) {
        ...
        if (params.getSslSocketFactory() != null) {
            SSLConnectionSocketFactory sslConnectionSocketFactory = new SSLConnectionSocketFactory(params.getSslSocketFactory(), (X509HostnameVerifier) params.getHostnameVerifier());
