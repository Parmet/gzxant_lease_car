            ...
            <div class="col-md-12">
                <div class="portlet box green-haze" style="padding: 15px">
                    ...
                    <div class="portlet-body form" id="dict_edit_table">
                        <form class="form-horizontal m-t" action="${rc.contextPath}/sys/config/insert" method="POST" id="dictForm">
...
<script type="text/javascript">
    ...
    $("#dictTree").jstree({
        ...
        if (dic_id) {
            $.ajax({
                url: '${rc.contextPath}/sys/config/select/' + dic_id,
                type: 'GET',
    ...
    $('.btn-delete').click(function () {
        layer.confirm('是否要删除此数据字典及其下级数？', {
            ...
            $.ajax({
                url: '${rc.contextPath}/sys/config/delete/' + dic_id,
                type: 'DELETE',
    ...
    $('.btn-rush').click(function () {
        ...
        $.ajax({
            url: '${rc.contextPath}/sys/config/rush',
            type: 'GET',
            success: function (data) {
               layer.msg('刷新成功');
            }
