    ...
    <form class="form-horizontal form-bordered" id="gzxantForm" >
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="belongstoId" id="belongstoId"
                       value="${entity.belongstoId}" placeholder="请输入车辆所属 引用"/>
            </div>
        </div>
                <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="date" id="date"
                       value="${entity.date}" placeholder="请输入事故日期"/>
            </div>
        </div>
                <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="driver" id="driver"
                       value="${entity.driver}" placeholder="请输入驾驶员"/>
            </div>
        </div>
                <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="place" id="place"
                       value="${entity.place}" placeholder="请输入事故地址"/>
            </div>
        </div>
                <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="detail" id="detail"
                       value="${entity.detail}" placeholder="请输入事故详情"/>
            </div>
        </div>
                <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="usePropertyId" id="usePropertyId"
                       value="${entity.usePropertyId}" placeholder="请输入使用性质 引用"/>
            </div>
        </div>
                <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="nature" id="nature"
                       value="${entity.nature}" placeholder="请输入事故性质 字典 单方事故、双方事故、多方事故"/>
            </div>
        </div>
                <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="responsibility" id="responsibility"
                       value="${entity.responsibility}" placeholder="请输入责任划分 字典 全责、无责、次责、不详、同等、主责"/>
            </div>
        </div>
                <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="minorWound" id="minorWound"
                       value="${entity.minorWound}" placeholder="请输入轻伤（人）"/>
            </div>
        </div>
                <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="seriousInjury" id="seriousInjury"
                       value="${entity.seriousInjury}" placeholder="请输入重伤（人）"/>
            </div>
        </div>
                <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="death" id="death"
                       value="${entity.death}" placeholder="请输入死亡（人）"/>
            </div>
        </div>
                <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="ourLosses" id="ourLosses"
                       value="${entity.ourLosses}" placeholder="请输入我方经济损失"/>
            </div>
        </div>
                <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="ourExpenses" id="ourExpenses"
                       value="${entity.ourExpenses}" placeholder="请输入我方医疗费用"/>
            </div>
        </div>
                <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="threeLosses" id="threeLosses"
                       value="${entity.threeLosses}" placeholder="请输入三者经济损失"/>
            </div>
        </div>
                <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="threeExpenses" id="threeExpenses"
                       value="${entity.threeExpenses}" placeholder="请输入三者医疗费用"/>
            </div>
        </div>
                <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="amountPaid" id="amountPaid"
                       value="${entity.amountPaid}" placeholder="请输入已赔付金额"/>
            </div>
        </div>
                <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="grade" id="grade"
                       value="${entity.grade}" placeholder="请输入事故等级 字典 轻微事故、一般事故、重大事故、特大事故"/>
            </div>
        </div>
                <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="processingState" id="processingState"
                       value="${entity.processingState}" placeholder="请输入处理状态 字典 未处理 处理中 已处理"/>
            </div>
        </div>
                <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="handlingProgress" id="handlingProgress"
                       value="${entity.handlingProgress}" placeholder="请输入事故处理进度 Y：已结案 N：待定损"/>
            </div>
        </div>
                <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="updateId" id="updateId"
                       value="${entity.updateId}" placeholder="请输入修改者id"/>
            </div>
        </div>
