<div class="wrapper wrapper-content animated fadeInRight">
    <form class="form-horizontal form-bordered" id="gzxantForm">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="carNumber" id="carNumber" value="${entity.carNumber}" readonly
                       placeholder="请输入车牌号"/>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="date" class="form-control" name="date" id="date" value="${entity.date}" readonly
                       placeholder="请输入事故日期"/>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="driver" id="driver" value="${entity.driver}" readonly
                       placeholder="请输入驾驶员"/>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="place" id="place" value="${entity.place}" readonly
                       placeholder="请输入事故地址"/>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="detail" id="detail" value="${entity.detail}" readonly
                       placeholder="请输入事故详情"/>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <select name="usePropertyId" class="form-control" disabled>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <select class="form-control" name="nature" id="nature" disabled>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <select type="text" class="form-control" name="responsibility" id="responsibility" disabled>
                    <option value="">请选择</option>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <select type="text" class="form-control" name="carType" id="carType" disabled>
                    <option value="">请选择</option>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="minorWound" id="minorWound" value="${entity.minorWound}" readonly
                       placeholder="请输入轻伤（人）"/>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="seriousInjury" id="seriousInjury" value="${entity.seriousInjury}" readonly
                       placeholder="请输入重伤（人）"/>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="death" id="death" value="${entity.death}" readonly
                       placeholder="请输入死亡（人）"/>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="ourLosses" id="ourLosses" value="${entity.ourLosses}" readonly
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="ourExpenses" id="ourExpenses" value="${entity.ourExpenses}" readonly
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="threeLosses" id="threeLosses" value="${entity.threeLosses}" readonly
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="threeExpenses" id="threeExpenses" value="${entity.threeExpenses}" readonly
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="amountPaid" id="amountPaid" value="${entity.amountPaid}" readonly
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <select type="text" class="form-control" name="grade" id="grade" disabled>
                    <option value="">请选择</option>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <select type="text" class="form-control" name="processingState" id="processingState" disabled>
                    <option value="">请选择</option>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <select type="text" class="form-control" name="handlingProgress" id="handlingProgress" disabled>
                    <option value="">请选择</option>
