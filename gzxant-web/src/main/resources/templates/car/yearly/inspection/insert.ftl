<div class="wrapper wrapper-content animated fadeInRight">
    <form class="form-horizontal form-bordered" id="gzxantForm">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="date" class="form-control" name="dateHandling" id="dateHandling"
                       placeholder="请输入办理日期"/>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="date" class="form-control" name="effectiveDate" id="effectiveDate"
                       placeholder="请输入年检有效期至"/>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label">年检办理人：</label>
            <div class="col-sm-8">
                <input type="text" class="form-control" name="transactor" id="transactor"
                       placeholder="请输入年检办理人"/>
            </div>
        </div>
        <div class="form-group">
